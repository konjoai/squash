...
class TestModuleCountGate(unittest.TestCase):
    ...
    def test_squash_module_count_is_36(self) -> None:
        ...
        # Sprint 8 (W182–W186) added annual_review.py, attestation_registry.py,
        ...
        # Sprint 14 B1 added hf_scanner.py (72) · B5 gateway.py (73) ·
        # B8 adapter_scanner.py (74) · B2 pdf_report.py (75).
        self.assertEqual(
            count,
            75,
            msg=f"squash/ has {count} Python files (expected 75 after B2). "
